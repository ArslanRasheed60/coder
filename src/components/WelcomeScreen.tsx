    ...
    <div className="bg-black min-h-screen flex flex-col items-center justify-center p-6">
      <div className="max-w-md w-full bg-black border border-white/10 rounded-xl p-6 shadow-lg">
        <h1 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
          <span>Buddy Boy</span>
          <span className="text-sm font-normal px-2 py-0.5 bg-blue-500/20 text-blue-400 rounded-md">Desktop Edition</span>
        </h1>
        
        <div className="mb-8">
          <h2 className="text-lg font-medium text-white mb-3">Welcome to Buddy Boy</h2>
          <p className="text-white/70 text-sm mb-4">
            Your intelligent AI coding companion, designed to help you analyze code, generate optimal solutions, and debug in real time.
          </p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-lg p-4 mb-6">
          ...
          <p className="text-white/70 text-sm mb-3">
            Before using the application, please configure your API key in Settings (supports OpenAI, Claude, and Gemini).
          </p>
          <Button 
